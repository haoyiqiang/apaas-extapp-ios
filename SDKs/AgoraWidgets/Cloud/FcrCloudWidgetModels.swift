...
// MARK: - Server object
struct FcrCloudFileListServerObject: Convertable {
    // File list
    let list: [File]
    // File list count
    let total: Int
...
extension FcrCloudFileListServerObject {
    struct File: Convertable {
...
extension FcrCloudFileListServerObject.File {
...
extension FcrCloudFileListServerObject.File.TaskProgress {
    // Converted V3
...
//extension FcrCloudFileServerObject {
