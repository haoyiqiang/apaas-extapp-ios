...
- (void)setupSubViews
{
    ...
    [self.chatButton setTitle:[@"fcr_hyphenate_im_chat" widget_localized] forState:UIControlStateNormal];
    ...
    [self.announcementButton setTitle:[@"fcr_hyphenate_im_announcement" widget_localized] forState:UIControlStateNormal];
